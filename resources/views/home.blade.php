          ...
          <div class="row">
            <div class="col-md-6">
              <div class="detail_box">
                ...
                <p>Halo semua! Selamat datang di web saya. Silahkan jelajahi web saya untuk mengetahui lebih banyak tentang saya.</p>
                <!-- Link menuju contact -->
                <!-- <a href="" class=""> -->
                <!-- End Link contact -->
              </div>
                  ...
                  <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        <div class="img-box">
                          <img src="{{ asset('asset-landing-page/images/me.png') }}" alt="" />
                        </div>
                      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="box">
              <div class="img-box">
                <img src="{{ asset('asset-landing-page/images/project1.png') }}" alt="" />
              </div>
              <div class="detail-box">
                <h5>PKWU</h5>
                <p>Web toko online</p>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6">
        <form action="">
          <div>
            <p>Gmail: rzenet289@gmail.com</p>
          </div>
          <div>
            <p>No Handphone: +62085882141206</p>
          </div>
          <!-- send -->
          <!-- <div class="d-flex"> -->
            <!-- <button>SEND</button> -->
